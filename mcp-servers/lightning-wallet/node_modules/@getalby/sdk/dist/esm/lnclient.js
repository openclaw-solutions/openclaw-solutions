...
class Invoice {
    ...
    validatePreimage(preimage) {
        if (!preimage || !this.paymentHash)
            return false;
        try {
            const preimageHash = bytesToHex$3(sha256$2(fromHexString(preimage)));
...
async function generateZapEvent({ satoshi, comment, p, e, relays }, options = {}) {
    ...
    nostrEvent.id = getEventHash$1(nostrEvent);
...
function getEventHash$1(event) {
    return bytesToHex$3(sha256$2(serializeEvent$1(event)));
}
...
const parseLnUrlPayResponse = async (data) => {
    ...
    try {
        ...
        metadataHash = bytesToHex$3(sha256$2(data.metadata + ""));
    }
    catch {
        metadata = [];
        metadataHash = bytesToHex$3(sha256$2("[]"));
    }
    let email = "";
    let image = "";
    let description = "";
...
//# sourceMappingURL=lnclient.js.map
