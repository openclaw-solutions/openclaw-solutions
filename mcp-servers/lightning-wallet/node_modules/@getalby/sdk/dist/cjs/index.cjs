...
function getEventHash$1(event) {
  let eventHash = sha256$1(utf8Encoder.encode(serializeEvent$1(event)));
...
class Nip47PublishTimeoutError extends Nip47TimeoutError {
}
class Nip47ReplyTimeoutError extends Nip47TimeoutError {
}
class Nip47PublishError extends Nip47Error {
}
class Nip47ResponseDecodingError extends Nip47Error {
}
class Nip47ResponseValidationError extends Nip47Error {
}
class Nip47UnexpectedResponseError extends Nip47Error {
}
class Nip47UnsupportedEncryptionError extends Nip47Error {
}
...
class NWCClient {
    ...
    constructor(options) {
        ...
        if (this.options.secret) {
            this.secret = (this.options.secret.toLowerCase().startsWith("nsec")
                ? nip19_exports.decode(this.options.secret).data
                : this.options.secret);
        }
        this.lud16 = this.options.lud16;
        this.walletPubkey = (this.options.walletPubkey.toLowerCase().startsWith("npub")
            ? nip19_exports.decode(this.options.walletPubkey).data
    ...
    get publicKey() {
        ...
        return getPublicKey(hexToBytes$2(this.secret));
    }
    get encryptionType() {
    ...
    signEvent(event) {
        ...
        return Promise.resolve(finalizeEvent(event, hexToBytes$2(this.secret)));
    }
    getEventHash(event) {
        return getEventHash$1(event);
    }
    close() {
    ...
    async encrypt(pubkey, content) {
        ...
        if (this.encryptionType === "nip04") {
            encrypted = await nip04_exports.encrypt(this.secret, pubkey, content);
        }
        else {
            const key = nip44_exports.getConversationKey(hexToBytes$2(this.secret), pubkey);
            encrypted = nip44_exports.encrypt(content, key);
        }
        return encrypted;
    }
    async decrypt(pubkey, content) {
        ...
        let decrypted;
        if (this.encryptionType === "nip04") {
            decrypted = await nip04_exports.decrypt(this.secret, pubkey, content);
        }
        else {
            const key = nip44_exports.getConversationKey(hexToBytes$2(this.secret), pubkey);
            decrypted = nip44_exports.decrypt(content, key);
        }
        return decrypted;
    }
    static getAuthorizationUrl(authorizationBasePath, options = {}, pubkey) {
     ...
     */
    static fromAuthorizationUrl(authorizationBasePath, options = {}, secret) {
        secret = secret || bytesToHex$3(generateSecretKey());
        ...
        const url = this.getAuthorizationUrl(authorizationBasePath, options, getPublicKey(hexToBytes$2(secret)));
        const height = 600;
        const width = 400;
        const top = window.outerHeight / 2 + window.screenY - height / 2;
        const left = window.outerWidth / 2 + window.screenX - width / 2;
        return new Promise((resolve, reject) => {
            const popup = window.open(url.toString(), `${document.title} - Wallet Connect`, `height=${height},width=${width},top=${top},left=${left}`);
            if (!popup) {
    ...
    async getWalletServiceInfo() {
        ...
        const events = await new Promise((resolve, reject) => {
            const events = [];
            const sub = this.pool.subscribe(this.relayUrls, {
                kinds: [13194],
                limit: 1,
        ...
        const notificationsTag = events[0].tags.find((t) => t[0] === "notifications");
    ...
    async getInfo() {
        try {
            const result = await this.executeNip47Request("get_info", {}, (result) => !!result.methods, { replyTimeout: 10000 });
            return result;
        }
        catch (error) {
    ...
    async getBudget() {
        try {
            const result = await this.executeNip47Request("get_budget", {}, (result) => result !== undefined, { replyTimeout: 10000 });
            return result;
        }
        catch (error) {
    ...
    async getBalance() {
        try {
            const result = await this.executeNip47Request("get_balance", {}, (result) => result.balance !== undefined, { replyTimeout: 10000 });
            return result;
        }
        catch (error) {
    ...
    async payInvoice(request) {
        try {
            const result = await this.executeNip47Request("pay_invoice", request, (result) => !!result);
            return result;
        }
        catch (error) {
    ...
    async payKeysend(request) {
        try {
            const result = await this.executeNip47Request("pay_keysend", request, (result) => !!result.preimage);
            return result;
        }
        catch (error) {
    ...
    async signMessage(request) {
        try {
            const result = await this.executeNip47Request("sign_message", request, (result) => result.message === request.message && !!result.signature);
            return result;
        }
        catch (error) {
    ...
    async createConnection(request) {
        try {
            const result = await this.executeNip47Request("create_connection", request, (result) => !!result.wallet_pubkey);
            return result;
        }
        catch (error) {
    ...
    async multiPayInvoice(request) {
        try {
            const results = await this.executeMultiNip47Request("multi_pay_invoice", request, request.invoices.length, (result) => !!result.preimage);
            return {
                invoices: results,
                // TODO: error handling
                errors: [],
    ...
    async multiPayKeysend(request) {
        try {
            const results = await this.executeMultiNip47Request("multi_pay_keysend", request, request.keysends.length, (result) => !!result.preimage);
            return {
                keysends: results,
                // TODO: error handling
                errors: [],
    ...
    async makeInvoice(request) {
        try {
            ...
            const result = await this.executeNip47Request("make_invoice", request, (result) => !!result.invoice);
            return result;
        }
        catch (error) {
    ...
    async makeHoldInvoice(request) {
        try {
            ...
            const result = await this.executeNip47Request("make_hold_invoice", request, (result) => !!result.invoice);
            return result;
        }
        catch (error) {
    ...
    async settleHoldInvoice(request) {
        try {
            const result = await this.executeNip47Request("settle_hold_invoice", request, (result) => !!result);
            return result;
        }
        catch (error) {
    ...
    async cancelHoldInvoice(request) {
        try {
            const result = await this.executeNip47Request("cancel_hold_invoice", request, (result) => !!result);
            return result;
        }
        catch (error) {
    ...
    async lookupInvoice(request) {
        try {
            const result = await this.executeNip47Request("lookup_invoice", request, (result) => !!result.invoice);
            return result;
        }
        catch (error) {
    ...
    async listTransactions(request) {
        try {
            ...
            const result = await this.executeNip47Request("list_transactions", request, (response) => !!response.transactions, { replyTimeout: 10000 });
            return result;
        }
        catch (error) {
    ...
    async subscribeNotifications(onNotification, notificationTypes) {
        let subscribed = true;
        let endPromise;
        let sub;
        (async () => {
            while (subscribed) {
                try {
                    ...
                    sub = this.pool.subscribe(this.relayUrls, {
    ...
    async executeNip47Request(nip47Method, params, resultValidator, timeoutValues) {
        await this._checkConnected();
        await this._selectEncryptionType();
        return new Promise((resolve, reject) => {
            (async () => {
                    ...
                    onevent: async (event) => {
                        ...
                        if (response.result) {
                            ...
                            if (resultValidator(response.result)) {
                                ...
                                clearTimeout(replyTimeoutCheck);
                                sub.close();
                                reject(new Nip47ResponseValidationError("response from NWC failed validation: " +
                                    JSON.stringify(response.result), "INTERNAL"));
                            }
                        }
                        else {
                            clearTimeout(replyTimeoutCheck);
                            ...
                            reject(new Nip47WalletError(response.error?.message || "unknown Error", response.error?.code || "INTERNAL"));
                        }
                    },
                });
                ...
                const replyTimeoutCheck = setTimeout(replyTimeout, timeoutValues?.replyTimeout || 60000);
                ...
                const publishTimeoutCheck = setTimeout(publishTimeout, timeoutValues?.publishTimeout || 5000);
                try {
    ...
    async executeMultiNip47Request(nip47Method, params, numPayments, resultValidator, timeoutValues) {
        await this._checkConnected();
        await this._selectEncryptionType();
        const results = [];
        return new Promise((resolve, reject) => {
                    ...
                    onevent: async (event) => {
                        ...
                        if (response.result) {
                            ...
                            if (dTag === undefined) {
                                clearTimeout(replyTimeoutCheck);
                                sub.close();
                                reject(new Nip47ResponseValidationError("No d tag found in response event", "INTERNAL"));
                                return;
                            }
                            results.push({
                                ...response.result,
                            ...
                            clearTimeout(replyTimeoutCheck);
                            sub.close();
                            reject(new Nip47UnexpectedResponseError(response.error?.message, response.error?.code));
                        }
                    },
                });
                function replyTimeout() {
    ...
    async _selectEncryptionType() {
        if (!this._encryptionType) {
            ...
            const encryptionType = this._findPreferredEncryptionType(walletServiceInfo.encryptions);
            if (!encryptionType) {
                throw new Nip47UnsupportedEncryptionError(`no compatible encryption or version found between wallet and client`, "UNSUPPORTED_ENCRYPTION");
            }
            if (encryptionType === "nip04") {
                console.warn("NIP-04 encryption is about to be deprecated. Please upgrade your wallet service to use NIP-44 instead.");
            }
            this._encryptionType = encryptionType;
        }
    }
    _findPreferredEncryptionType(encryptions) {
...
class NostrWebLNProvider {
    ...
    static async fromAuthorizationUrl(authorizationBasePath, options = {}, secret) {
    ...
    async getInfo() {
        ...
        try {
            ...
            const result = {
                methods: nip47Result.methods.map((key) => nip47ToWeblnRequestMap[key]),
                node: {
    ...
    async sendPaymentAsync(invoice) {
        await this.checkEnabled();
    ...
    async keysend(args) {
        await this.checkEnabled();
        const nip47Result = await this.client.payKeysend(mapKeysendToNip47Keysend(args));
        const result = { preimage: nip47Result.preimage };
    ...
    async makeInvoice(args) {
        await this.checkEnabled();
        const requestInvoiceArgs = typeof args === "object" ? args : undefined;
        const amount = +(requestInvoiceArgs?.amount ?? args);
        if (!amount) {
            throw new Error("No amount specified");
        }
...
function mapNip47TransactionToTransaction(transaction) {
    return {
        ...transaction,
        // NWC uses msats - convert to sats for webln
...
function mapKeysendToNip47Keysend(args) {
    return {
...
class OauthWeblnProvider {
    ...
    async openAuthorization() {
        ...
        return new Promise((resolve, reject) => {
            const popup = window.open(url, `${document.title} - WebLN enable`, `height=${height},width=${width},top=${top},left=${left}`);
...
class NWAClient {
    constructor(options) {
        this.appSecretKey = options.appSecretKey || bytesToHex$3(generateSecretKey());
        this.options = {
            ...options,
            appPubkey: getPublicKey(hexToBytes$2(this.appSecretKey)),
        };
    ...
    static parseWalletAuthUrl(walletAuthUrl) {
        ...
        return {
            ...
            requestMethods,
            notificationTypes,
            budgetRenewal: url.searchParams.get("budget_renewal"),
    ...
    async subscribe(args) {
        ...
        (async () => {
            while (subscribed) {
                try {
                    await this._checkConnected();
                    sub = this.pool.subscribe(this.options.relayUrls, {
    ...
    async _checkConnected() {
        ...
        try {
            ...
            console.error("failed to connect to any relay", error);
            throw new Nip47NetworkError("Failed to connect to " + this.options.relayUrls.join(","), "OTHER");
        }
    }
}

class NWCWalletServiceKeyPair {
    constructor(walletSecret, clientPubkey) {
        ...
        this.walletPubkey = getPublicKey(hexToBytes$2(this.walletSecret));
    }
}
class NWCWalletService {
    ...
    async publishWalletServiceInfoEvent(walletSecret, supportedMethods, supportedNotifications) {
        try {
            await this._checkConnected();
            const eventTemplate = {
                kind: 13194,
    ...
    async subscribe(keypair, handler) {
        let subscribed = true;
        let endPromise;
        let onRelayDisconnect;
        let sub;
        (async () => {
            while (subscribed) {
                try {
                    ...
                    sub.onevent = async (event) => {
                        try {
                            ...
                            const encryptionType = (event.tags.find((t) => t[0] === "encryption")?.[1] || "nip04");
                            ...
                            switch (request.method) {
                                case "get_info":
                                    ...
                                    break;
                                case "make_invoice":
                                    responsePromise = handler.makeInvoice?.(request.params);
                                    break;
                                case "pay_invoice":
                                    responsePromise = handler.payInvoice?.(request.params);
                                    break;
                                case "pay_keysend":
                                    responsePromise = handler.payKeysend?.(request.params);
                                    break;
                                case "get_balance":
                                    responsePromise = handler.getBalance?.();
                                    break;
                                case "lookup_invoice":
                                    responsePromise = handler.lookupInvoice?.(request.params);
                                    break;
                                case "list_transactions":
                                    responsePromise = handler.listTransactions?.(request.params);
                                    break;
                                case "sign_message":
                                    responsePromise = handler.signMessage?.(request.params);
                                    break;
                            ...
                            const responseEventTemplate = {
                                ...
                                created_at: Math.floor(Date.now() / 1000),
                                tags: [["e", event.id]],
                                content: await this.encrypt(keypair, JSON.stringify({
                                    result_type: request.method,
                                    ...response,
                                }), encryptionType),
                            };
                            const responseEvent = await this.signEvent(responseEventTemplate, keypair.walletSecret);
    ...
    signEvent(event, secretKey) {
        return Promise.resolve(finalizeEvent(event, hexToBytes$2(secretKey)));
    }
    close() {
        return this.relay.close();
    }
    async encrypt(keypair, content, encryptionType) {
        let encrypted;
        // console.info("encrypting with" + encryptionType);
        if (encryptionType === "nip04") {
            encrypted = await nip04_exports.encrypt(keypair.walletSecret, keypair.clientPubkey, content);
        }
        else {
            const key = nip44_exports.getConversationKey(hexToBytes$2(keypair.walletSecret), keypair.clientPubkey);
            encrypted = nip44_exports.encrypt(content, key);
        }
        return encrypted;
    }
    async decrypt(keypair, content, encryptionType) {
        let decrypted;
        // console.info("decrypting with" + encryptionType);
        if (encryptionType === "nip04") {
            decrypted = await nip04_exports.decrypt(keypair.walletSecret, keypair.clientPubkey, content);
        }
        else {
            const key = nip44_exports.getConversationKey(hexToBytes$2(keypair.walletSecret), keypair.clientPubkey);
            decrypted = nip44_exports.decrypt(content, key);
...
class ReceiveInvoice {
    constructor(nwcClient, transaction) {
    ...
    onPaid(callback) {
        (async () => {
            ...
            const callbackWrapper = (receivedPayment) => {
            ...
            if (!supportsNotifications) {
                ...
                const onNotification = (notification) => {
                    if (notification.notification.payment_hash ===
                        this.transaction.payment_hash) {
                        callbackWrapper(notification.notification);
                    }
                };
                this._unsubscribeFunc = unsubscribeWrapper(await this._nwcClient.subscribeNotifications(onNotification, [
                    "payment_received",
                ]));
            }
        })();
    ...
    _onPaidPollingFallback(callback) {
        let subscribed = true;
...
async function resolveAmount(amount) {
...
class LNClient {
     ...
     */
    async pay(recipient, amount, args) {
     ...
     */
    async requestPayment(amount, args) {
...
const USD = (amount) => new FiatAmount(amount, "USD");
const EUR = (amount) => new FiatAmount(amount, "EUR");
const JPY = (amount) => new FiatAmount(amount, "JPY");
const GBP = (amount) => new FiatAmount(amount, "GBP");
const CHF = (amount) => new FiatAmount(amount, "CHF");
...
exports.JPY = JPY;
exports.LN = LNClient;
exports.LNClient = LNClient;
exports.NWAClient = NWAClient;
exports.NWC = NWC;
exports.NWCClient = NWCClient;
exports.NWCWalletService = NWCWalletService;
exports.NWCWalletServiceKeyPair = NWCWalletServiceKeyPair;
exports.Nip47Error = Nip47Error;
exports.Nip47NetworkError = Nip47NetworkError;
exports.Nip47PublishError = Nip47PublishError;
exports.Nip47PublishTimeoutError = Nip47PublishTimeoutError;
exports.Nip47ReplyTimeoutError = Nip47ReplyTimeoutError;
exports.Nip47ResponseDecodingError = Nip47ResponseDecodingError;
exports.Nip47ResponseValidationError = Nip47ResponseValidationError;
exports.Nip47TimeoutError = Nip47TimeoutError;
exports.Nip47UnexpectedResponseError = Nip47UnexpectedResponseError;
exports.Nip47UnsupportedEncryptionError = Nip47UnsupportedEncryptionError;
exports.Nip47WalletError = Nip47WalletError;
exports.NostrWebLNProvider = NostrWebLNProvider;
exports.OAuth2Bearer = OAuth2Bearer;
exports.OAuth2User = OAuth2User;
exports.OAuthClient = OAuthClient;
exports.OauthWeblnProvider = OauthWeblnProvider;
